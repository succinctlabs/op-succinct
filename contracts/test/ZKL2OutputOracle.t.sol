...
contract ZKL2OutputOracleTest is Test, Utils {
    bytes32 STARTING_OUTPUT_ROOT =
        0x5DE5BC23543212ACFE6D68CCB2F243C80CBD3765782F424DEF4B1E68BABCFE94;
    uint STARTING_TIMESTAMP = 1723717092;
    uint STARTING_BLOCK_NUM = 15954957;

    bytes32 VK =
        0x0092df62aaa9095510bc567d8e3f4c43fe3f4b1884e1a7610c1a892666089519;
    uint OP_SEPOLIA_CHAIN_ID = 11155420;

    uint constant L1_BLOCK_NUM = 6504359;
    bytes32 L1_HEAD =
        0x648a03238b239b1afa20953c99812a0640fec18776b07af8b8c0cdbceacf2dc1;

    bytes32 claimedOutputRoot =
        0x48A9017ABA4E1E3FCDCF9E792FD2B749F9852FA7CF677021033E39FA2E2608EB;
    ...
    function testZKL2OOFreshDeployment() public {
        l2oo = ZKL2OutputOracle(
            deployWithConfig(config, STARTING_OUTPUT_ROOT, STARTING_TIMESTAMP)
        );
