    ...
    T: Transport + Clone,
{
    ...
    async fn should_attempt_resolution(
        ...
        let oldest_game =
            OPSuccinctFaultDisputeGame::new(oldest_game_address, l1_provider_with_wallet.clone());
    ...
    async fn resolve_games(
        ...
        let (should_attempt_resolution, game_address) = self
            .should_attempt_resolution(oldest_game_index, l1_provider_with_wallet.clone())
            .await?;
