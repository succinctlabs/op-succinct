...
fn main() {
    ...
    sp1_helper::build_program_with_args(&format!("{}/../zkvm-client", env!("CARGO_MANIFEST_DIR")), client_build_args);
    ...
    sp1_helper::build_program_with_args(&format!("{}/../aggregation", env!("CARGO_MANIFEST_DIR")), agg_build_args);
}
