...
build-range-elfs:
    ...
    ~/.sp1/bin/cargo-prove prove build --elf-name range-elf-embedded --docker --tag v6.2.3 --output-directory ../../../elf

    cd ../celestia
    ~/.sp1/bin/cargo-prove prove build --elf-name celestia-range-elf-embedded --docker --tag v6.2.3 --output-directory ../../../elf

    cd ../eigenda
    ~/.sp1/bin/cargo-prove prove build --elf-name eigenda-range-elf-embedded --docker --tag v6.2.3 --output-directory ../../../elf

    cd ../altda
    ~/.sp1/bin/cargo-prove prove build --elf-name altda-range-elf-embedded --docker --tag v6.2.3 --output-directory ../../../elf
...
build-agg-elf:
    ...
    ~/.sp1/bin/cargo-prove prove build --elf-name aggregation-elf --docker --tag v6.2.3 --output-directory ../../elf
