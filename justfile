...
build-range-elfs:
    ...
    ~/.sp1/bin/cargo-prove prove build --elf-name range-elf-embedded --docker --tag v6.8.0 --output-directory ../../../elf

    cd ../eigenda
    ~/.sp1/bin/cargo-prove prove build --elf-name eigenda-range-elf-embedded --docker --tag v6.8.0 --output-directory ../../../elf

    cd ../altda
    ~/.sp1/bin/cargo-prove prove build --elf-name altda-range-elf-embedded --docker --tag v6.8.0 --output-directory ../../../elf
...
build-agg-elf:
    ...
    ~/.sp1/bin/cargo-prove prove build --elf-name aggregation-elf --docker --tag v6.8.0 --output-directory ../../elf
