...
build-range-elfs:
    ...
    cd ../altda
    ~/.sp1/bin/cargo-prove prove build --elf-name altda-range-elf-embedded --docker --tag v6.5.0 --output-directory ../../../elf
...
build-agg-elf:
    ...
    ~/.sp1/bin/cargo-prove prove build --elf-name aggregation-elf --docker --tag v6.5.0 --output-directory ../../elf
