...
cargo prove build --elf-name range-elf-bump --docker --tag v5.0.5
cargo prove build --elf-name range-elf-embedded --docker --tag v5.0.5 --features embedded

cd ../aggregation
# Build the aggregation-elf
cargo prove build --elf-name aggregation-elf --docker --tag v5.0.5
```
