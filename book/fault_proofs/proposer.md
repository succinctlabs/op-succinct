...
| `PRIVATE_STDIN` | Whether proof requests should upload stdin through the private artifact path. | `false` |
...
PRIVATE_STDIN=false              # Upload stdin through the private artifact path
