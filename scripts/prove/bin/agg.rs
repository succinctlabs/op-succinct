...
use sp1_sdk::{
    utils, CpuProver, Elf, HashableKey, ProveRequest, Prover, ProverClient, ProvingKey, SP1Proof,
...
async fn main() -> Result<()> {
    ...
    let (proofs, boot_infos) = load_aggregation_proof_data(args.proofs, &prover, &range_vk).await;
