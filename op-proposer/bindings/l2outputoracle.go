...
// Initialize is a paid mutator transaction binding the contract method 0x2aaffe58.
//
// Solidity: function initialize(uint256 _submissionInterval, uint256 _l2BlockTime, uint256 _startingBlockNumber, uint256 _startingTimestamp, address _proposer, address _challenger, uint256 _finalizationPeriodSeconds, uint256 _chainId) returns()
func (_L2OutputOracle *L2OutputOracleTransactor) Initialize(opts *bind.TransactOpts, _submissionInterval *big.Int, _l2BlockTime *big.Int, _startingBlockNumber *big.Int, _startingTimestamp *big.Int, _proposer common.Address, _challenger common.Address, _finalizationPeriodSeconds *big.Int, _chainId *big.Int) (*types.Transaction, error) {
	return _L2OutputOracle.contract.Transact(opts, "initialize", _submissionInterval, _l2BlockTime, _startingBlockNumber, _startingTimestamp, _proposer, _challenger, _finalizationPeriodSeconds, _chainId)
}

// Initialize is a paid mutator transaction binding the contract method 0x2aaffe58.
//
// Solidity: function initialize(uint256 _submissionInterval, uint256 _l2BlockTime, uint256 _startingBlockNumber, uint256 _startingTimestamp, address _proposer, address _challenger, uint256 _finalizationPeriodSeconds, uint256 _chainId) returns()
func (_L2OutputOracle *L2OutputOracleSession) Initialize(_submissionInterval *big.Int, _l2BlockTime *big.Int, _startingBlockNumber *big.Int, _startingTimestamp *big.Int, _proposer common.Address, _challenger common.Address, _finalizationPeriodSeconds *big.Int, _chainId *big.Int) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.Initialize(&_L2OutputOracle.TransactOpts, _submissionInterval, _l2BlockTime, _startingBlockNumber, _startingTimestamp, _proposer, _challenger, _finalizationPeriodSeconds, _chainId)
}

// Initialize is a paid mutator transaction binding the contract method 0x2aaffe58.
//
// Solidity: function initialize(uint256 _submissionInterval, uint256 _l2BlockTime, uint256 _startingBlockNumber, uint256 _startingTimestamp, address _proposer, address _challenger, uint256 _finalizationPeriodSeconds, uint256 _chainId) returns()
func (_L2OutputOracle *L2OutputOracleTransactorSession) Initialize(_submissionInterval *big.Int, _l2BlockTime *big.Int, _startingBlockNumber *big.Int, _startingTimestamp *big.Int, _proposer common.Address, _challenger common.Address, _finalizationPeriodSeconds *big.Int, _chainId *big.Int) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.Initialize(&_L2OutputOracle.TransactOpts, _submissionInterval, _l2BlockTime, _startingBlockNumber, _startingTimestamp, _proposer, _challenger, _finalizationPeriodSeconds, _chainId)
}
...
// SetInitialOutputRoot is a paid mutator transaction binding the contract method 0xe6ee17aa.
//
// Solidity: function setInitialOutputRoot(bytes32 _outputRoot) returns()
func (_L2OutputOracle *L2OutputOracleTransactor) SetInitialOutputRoot(opts *bind.TransactOpts, _outputRoot [32]byte) (*types.Transaction, error) {
	return _L2OutputOracle.contract.Transact(opts, "setInitialOutputRoot", _outputRoot)
}

// SetInitialOutputRoot is a paid mutator transaction binding the contract method 0xe6ee17aa.
//
// Solidity: function setInitialOutputRoot(bytes32 _outputRoot) returns()
func (_L2OutputOracle *L2OutputOracleSession) SetInitialOutputRoot(_outputRoot [32]byte) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.SetInitialOutputRoot(&_L2OutputOracle.TransactOpts, _outputRoot)
}

// SetInitialOutputRoot is a paid mutator transaction binding the contract method 0xe6ee17aa.
//
// Solidity: function setInitialOutputRoot(bytes32 _outputRoot) returns()
func (_L2OutputOracle *L2OutputOracleTransactorSession) SetInitialOutputRoot(_outputRoot [32]byte) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.SetInitialOutputRoot(&_L2OutputOracle.TransactOpts, _outputRoot)
}
...
// SetVerifierGateway is a paid mutator transaction binding the contract method 0xc2507f96.
//
// Solidity: function setVerifierGateway(address _verifierGateway) returns()
func (_L2OutputOracle *L2OutputOracleTransactor) SetVerifierGateway(opts *bind.TransactOpts, _verifierGateway common.Address) (*types.Transaction, error) {
	return _L2OutputOracle.contract.Transact(opts, "setVerifierGateway", _verifierGateway)
}

// SetVerifierGateway is a paid mutator transaction binding the contract method 0xc2507f96.
//
// Solidity: function setVerifierGateway(address _verifierGateway) returns()
func (_L2OutputOracle *L2OutputOracleSession) SetVerifierGateway(_verifierGateway common.Address) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.SetVerifierGateway(&_L2OutputOracle.TransactOpts, _verifierGateway)
}

// SetVerifierGateway is a paid mutator transaction binding the contract method 0xc2507f96.
//
// Solidity: function setVerifierGateway(address _verifierGateway) returns()
func (_L2OutputOracle *L2OutputOracleTransactorSession) SetVerifierGateway(_verifierGateway common.Address) (*types.Transaction, error) {
	return _L2OutputOracle.Contract.SetVerifierGateway(&_L2OutputOracle.TransactOpts, _verifierGateway)
}
